...
public class DataBase extends SQLiteOpenHelper {
    ...
    public List<RecurringDeposit> RecurringDepositListForSelectedYear(String columnName ,String Amount,String Year){
        List<RecurringDeposit> recurringDepositList=new ArrayList<RecurringDeposit>();
        recurringDepositList= RetrievingRD(columnName,Amount,Year,"<",recurringDepositList,"desc");
        recurringDepositList= RetrievingRD(columnName,Amount,Year,"=",recurringDepositList,"");
        recurringDepositList= RetrievingRD(columnName,Amount,Year,">",recurringDepositList,"");
